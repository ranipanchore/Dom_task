let investors = [
  ...
  let divApp = document.querySelector('button');
  divApp.style.width = "100%";
  divApp.style.display = "grid";
  divApp.style.gridTemplateRows = "repeat(4,1fr)";
  divApp.style.gridTemplateColumns = "repeat(3,1fr)";
  
  divApp.addEventListener("click", fetchData);
  ...
  function fetchData(){
    ...
    for(let i=0; i<investors.length; i++){
        ...
        divApp.append(mainDiv); 

        let imgDiv = document.createElement("img");
        imgDiv.src = investors[i].image;
        ...
        companyLogo.innerText = investors[i].companyLogo;
        mainDiv.append(companyLogo);
